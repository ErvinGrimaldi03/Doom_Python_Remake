...
class BSP:
    ...
    def get_sub_sectors_height(self):
    ...
    def check_bbox(self, bbox):
        a, b = Vector2(bbox.left, bbox.bottom), Vector2(bbox.left, bbox.top)
        c, d = Vector2(bbox.right, bbox.top), Vector2(bbox.right, bbox.bottom)
